...
- [Rafid Property Intelligence](https://rafid-agent-api.vercel.app) - AI-agent-native property intelligence with Oman-specific market context, real partner-fed Al Mouj Muscat sales data, provenance, confidence, MCP, OpenAPI and x402 pay-per-call. ([GitHub](https://github.com/iabdullahm/rafid-agent-api))
