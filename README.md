...
- - [Rafid Property Intelligence](https://rafid-agent-api.vercel.app) - Oman property intelligence API for AI agents: rental yield/comparison/maintenance-reserve metrics, and Al Mouj Muscat market analysis using real partner-fed sale records. Pay-per-call x402 on Base (USDC) or API key; MCP server included. ([GitHub](https://github.com/iabdullahm/rafid-agent-api))
